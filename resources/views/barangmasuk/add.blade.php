    ...
    function deleteItem(key) {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                let deleteUrl = '{{ route("barang-masuk.removecartitem", ":key") }}';
        ...
        $('.add-to-cart-form').on('submit', function (e) {
            ...
            $.ajax({
                ...
                error: function (xhr, status, error) {
                    // Menangani jika ada error pada request
        ...
        $('#emptyCartBtn').on('click', function (e) {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        url: "{{ route('barang-masuk.emptyCart') }}",  // Gantilah dengan route yang sesuai
                        method: 'POST',
                        data: {
